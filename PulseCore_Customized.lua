...
-- Velocity method selector removed: WalkSpeed is the only supported method.
...
clientModules.personalization.defaultColors = {
    Cyan = COLORS.Cyan,
...
clientModules.personalization.themes = {
    {
        ...
        dark = Color3.fromRGB(68, 68, 68),
        deep = Color3.fromRGB(18, 18, 18),
    },
    {
        name = "Purple",
        accent = Color3.fromRGB(190, 145, 255),
        dark = Color3.fromRGB(86, 48, 125),
        deep = Color3.fromRGB(30, 18, 43),
    },
    {
        name = "Blue",
        accent = Color3.fromRGB(120, 180, 255),
        dark = Color3.fromRGB(36, 78, 125),
        deep = Color3.fromRGB(13, 24, 40),
    },
    {
        name = "Red",
        accent = Color3.fromRGB(255, 120, 130),
        dark = Color3.fromRGB(126, 43, 53),
        deep = Color3.fromRGB(39, 12, 16),
    },
    {
        name = "Green",
        accent = Color3.fromRGB(120, 225, 170),
        dark = Color3.fromRGB(39, 111, 75),
        deep = Color3.fromRGB(12, 36, 24),
    },
}
...
local function personalizationColorsEqual(a, b)
...
function clientModules.personalization.applyTheme(index)
    ...
    COLORS.Card = Color3.new(
        math.clamp(theme.deep.R + 0.025, 0, 1),
        math.clamp(theme.deep.G + 0.025, 0, 1),
        math.clamp(theme.deep.B + 0.025, 0, 1)
    )
    COLORS.Input = Color3.new(
        math.clamp(theme.deep.R * 0.82, 0, 1),
        math.clamp(theme.deep.G * 0.82, 0, 1),
        math.clamp(theme.deep.B * 0.82, 0, 1)
    )
    COLORS.Border = theme.dark:Lerp(Color3.new(1, 1, 1), 0.08)
    COLORS.Sidebar = theme.deep
    COLORS.Topbar = theme.deep
    COLORS.Text = Color3.fromRGB(242, 242, 242)
    COLORS.MutedText = Color3.fromRGB(165, 165, 165)

    if screenGui and screenGui.Parent then
        for _, object in ipairs(screenGui:GetDescendants()) do
            if object:IsA("GuiObject") then
                if personalizationColorsEqual(object.BackgroundColor3, clientModules.personalization.defaultColors.Cyan) then
                    object.BackgroundColor3 = COLORS.Cyan
                elseif personalizationColorsEqual(object.BackgroundColor3, clientModules.personalization.defaultColors.CyanDark) then
                    object.BackgroundColor3 = COLORS.CyanDark
                elseif personalizationColorsEqual(object.BackgroundColor3, clientModules.personalization.defaultColors.CyanDeep) then
                    object.BackgroundColor3 = COLORS.CyanDeep
                elseif personalizationColorsEqual(object.BackgroundColor3, clientModules.personalization.defaultColors.Panel) then
                    object.BackgroundColor3 = COLORS.Panel
                elseif personalizationColorsEqual(object.BackgroundColor3, clientModules.personalization.defaultColors.Card) then
                    object.BackgroundColor3 = COLORS.Card
                elseif personalizationColorsEqual(object.BackgroundColor3, clientModules.personalization.defaultColors.Input) then
                    object.BackgroundColor3 = COLORS.Input
                elseif personalizationColorsEqual(object.BackgroundColor3, clientModules.personalization.defaultColors.Border) then
                    object.BackgroundColor3 = COLORS.Border
                elseif personalizationColorsEqual(object.BackgroundColor3, clientModules.personalization.defaultColors.Sidebar) then
                    object.BackgroundColor3 = COLORS.Sidebar
                elseif personalizationColorsEqual(object.BackgroundColor3, clientModules.personalization.defaultColors.Topbar) then
                    object.BackgroundColor3 = COLORS.Topbar
                end

                if object:IsA("TextLabel") or object:IsA("TextButton") or object:IsA("TextBox") then
                    if personalizationColorsEqual(object.TextColor3, clientModules.personalization.defaultColors.Cyan) then
                        object.TextColor3 = COLORS.Cyan
                    elseif personalizationColorsEqual(object.TextColor3, clientModules.personalization.defaultColors.Text) then
                        object.TextColor3 = COLORS.Text
                    elseif personalizationColorsEqual(object.TextColor3, clientModules.personalization.defaultColors.MutedText) then
                        object.TextColor3 = COLORS.MutedText
                    end
                end
            elseif object:IsA("UIStroke") then
                if personalizationColorsEqual(object.Color, clientModules.personalization.defaultColors.Cyan) then
                    object.Color = COLORS.Cyan
                elseif personalizationColorsEqual(object.Color, clientModules.personalization.defaultColors.Border) then
...
function clientModules.personalization.setTransparency(value)
    ...
    clientModules.personalization.transparency = math.clamp(value, 0.05, 0.45)
...
-- Disabled features requested for this customized build.
clientModules.speedControl.standardMethod = "WalkSpeed"
clientModules.boostTabs.enabled = false
clientModules.inventoryOrder.enabled = false
if clientModules.boostTabs.setEnabled then
    local originalBoostTabsSetEnabled = clientModules.boostTabs.setEnabled
    clientModules.boostTabs.setEnabled = function()
        clientModules.boostTabs.enabled = false
...
function     local button = clientModules.fun.flingButton
    if not button then
        return
    end
